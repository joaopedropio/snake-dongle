...
<img src="images/dongle.webp"/>
<table>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/gallery/img1.webp"><img src="images/gallery/img1_thumb.webp" alt="case" alt="case" style="width:500px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/gallery/img2.webp"><img src="images/gallery/img2_thumb.webp" alt="case" alt="case" style="width:500px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/gallery/img3.webp"><img src="images/gallery/img3_thumb.webp" alt="case" alt="case" style="width:500px;"/></td>
    </tr>
...
<table>
    ...
    <tr>
        <td><img src="images/connectivity/usb_connected.webp" alt="case" style="width:150px;"/></td>
        <td>The First symbol (usb plug) has two states:<br> <strong>connected</strong>: usb plug with 'correct sign'.</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/usb_disconnected.webp" alt="case" style="width:150px;"/></td>
        <td><strong>disconnected</strong>: usb plug with 'x'.</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/ble.webp" alt="case" style="width:150px;"/></td>
        <td>The Second symbol (bluetooth logo) is static. The only purpose of this symbol is to indicate whether the USB transport or the bluetooth transport is selected.</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/selected.webp" alt="case" style="width:150px;"/></td>
        <td>The symbol with the primary color will be the selected one (usb transport is selected in this example).</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/number.webp" alt="case" style="width:150px;"/></td>
        <td>The third symbol indicate the current bluetooth profile number. It goes from 1 to 5. You can switch between them by pressing BT_SEL from 0-4. You can check <a href="https://zmk.dev/docs/keymaps/behaviors/bluetooth">this</a> page for more information.</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/unbind.webp" alt="case" style="width:150px;"/></td>
        <td>The forth symbol indicate the status of the current bluetooth profile. <br><strong>Dotted line square</strong>: not binded.</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/disconnected.webp" alt="case" style="width:150px;"/></td>
        <td><strong>Square with 'x'</strong>: binded but disconnected.</td>
    </tr>
    <tr>
        <td><img src="images/connectivity/connected.webp" alt="case" style="width:150px;"/></td>
        <td><strong>Square with correct sign</strong>: binded and connected.</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_c.webp"><img src="images/themes/snake_theme_c_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_c.webp"><img src="images/themes/menu_theme_c_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin C</td>
        <td>Complete custom theme made by chat gpt</td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_1.webp"><img src="images/themes/snake_theme_1_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_1.webp"><img src="images/themes/menu_theme_1_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 01</td>
        <td><a href="https://lospec.com/palette-list/nostalgia">nostalgia palette</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_2.webp"><img src="images/themes/snake_theme_2_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_2.webp"><img src="images/themes/menu_theme_2_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 02</td>
        <td><a href="https://lospec.com/palette-list/b4sement">b4sement</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_3.webp"><img src="images/themes/snake_theme_3_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_3.webp"><img src="images/themes/menu_theme_3_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 03</td>
        <td><a href="https://lospec.com/palette-list/kirokaze-gameboy">kirokaze gameboy</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_4.webp"><img src="images/themes/snake_theme_4_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_4.webp"><img src="images/themes/menu_theme_4_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 04</td>
        <td><a href="https://lospec.com/palette-list/moonlight-gb">moonlight-gb</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_5.webp"><img src="images/themes/snake_theme_5_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_5.webp"><img src="images/themes/menu_theme_5_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 05</td>
        <td><a href="https://lospec.com/palette-list/cherrymelon">cherrymelon</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_6.webp"><img src="images/themes/snake_theme_6_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_6.webp"><img src="images/themes/menu_theme_6_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 06</td>
        <td><a href="https://lospec.com/palette-list/bittersweet">bittersweet</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_7.webp"><img src="images/themes/snake_theme_7_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_7.webp"><img src="images/themes/menu_theme_7_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 07</td>
        <td><a href="https://lospec.com/palette-list/lava-gb">lava-gb</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_8.webp"><img src="images/themes/snake_theme_8_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_8.webp"><img src="images/themes/menu_theme_8_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 08</td>
        <td><a href="https://lospec.com/gallery/dogmaster/cave">cave</a></td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_9.webp"><img src="images/themes/snake_theme_9_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_9.webp"><img src="images/themes/menu_theme_9_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 09</td>
        <td>Eva 01 neon genesis evangelion</td>
    </tr>
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/snake_theme_10.webp"><img src="images/themes/snake_theme_10_thumb.webp" alt="case" style="width:150px;"/></td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/themes/menu_theme_10.webp"><img src="images/themes/menu_theme_10_thumb.webp" alt="case" style="width:150px;"/></td>
        <td>Skin 10</td>
        <td>neon colors</td>
    </tr>
</table>
...
| --------- | ----------- | ----- | ----- |
| `CONFIG_SNAKE_FATNESS` | Any number equal or above 0 | 1 | Amount the snake grows per food (if value is 0, the snake will not grow and will never die). |
...
| `CONFIG_USE_BUZZER` | y or n | n | Enable sound effects. You can (dis)enable each of the sound with the following variables. |
| `CONFIG_USE_SPLASH_SOUND` | y or n | n | Enable sound when dongle is initializing. |
...
| `CONFIG_USE_STATUS_SOUND` | y or n | y | Enable sound when (dis)connecting peripherals. |
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/example/snake2_logo.webp"><img src="images/example/snake2_logo_thumb.webp" alt="case" style="width:200px;"/></a></td>
        <td>On splash screen you can change the logo. The default is just 'snake'. If you want to change to snake 2 logo, set CONFIG_SPLASH_USE_SNAKE_2=y.</td>
    </tr>
</table>
...
CONFIG_THEME_FONT_BG_COLOR="#212121"
...
<table>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/case.webp"><img src="images/bom/case_thumb.webp" alt="case" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/controller.webp"><img src="images/bom/controller_thumb.webp" alt="controller" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/screen.webp"><img src="images/bom/screen_thumb.webp" alt="screen" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/screw.webp"><img src="images/bom/screw_thumb.webp" alt="screw" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/insert.webp"><img src="images/bom/insert_thumb.webp" alt="insert" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/nut.webp"><img src="images/bom/nut_thumb.webp" alt="nut" style="width:200px;"/></a></td>
        <td>M2 Hex Nut</td>
        <td>4x</td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/wire.webp"><img src="images/bom/wire_thumb.webp" alt="nut" style="width:200px;"/></a></td>
        <td>1.27mm Flat Ribbon Cable</td>
        <td>-</td>
        <td><a href="https://pt.aliexpress.com/item/1005007868158870.html">aliexpress</a></td>
        <td>Any wire might get the job done. I had some hard time soldering these 1.27mm wires. Maybe soldering with a larger gauge wire would be easier but be careful with the small internal space of the case.</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/bom/buzzer.webp"><img src="images/bom/buzzer_thumb.webp" alt="buzzer" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/tape.webp"><img src="images/bom/tape_thumb.webp" alt="tape" style="width:200px;"/></a></td>
    ...
    <tr>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/bom/trimpot.webp"><img src="images/bom/trimpot_thumb.webp" alt="trimpot" style="width:200px;"/></a></td>
        <td>Trimpot 500R</td>
        <td>1x</td>
...
<table>
    ...
    <tr>
        <td>01</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build1.webp"><img src="images/build/build1_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>This is basically the material needed to build.</td>
    </tr>
    <tr>
        <td>02</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build00.webp"><img src="images/build/build00_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>I would suggest you first sand these parts so the push buttons and the base fit perfectly.</td>
    </tr>
    <tr>
        <td>03</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build0.webp"><img src="images/build/build0_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>Place the heat brass inserts. I did at this at nearly the of the build. Doing it right from the start is much easier.</td>
    </tr>
    <tr>
        <td>04</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build2.webp"><img src="images/build/build2_thumb.webp" alt="case" style="width:300px;"/></a></td>
    ...
    <tr>
        <td>05</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build3.webp"><img src="images/build/build3_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>I would suggest to cut wires about this size or a little bit more. If the wires are too short the controller might not sit well on the base. If the wires are too long they might not fit inside the case later, even more so if you decide to use the buzzer (which is totally optional).</td>
    </tr>
    <tr>
        <td>06</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build4.webp"><img src="images/build/build4_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>This is the front part after soldering.</td>
    </tr>
        <td>07</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build17.webp"><img src="images/build/build17_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>Desolder the hearder pins and solder new wires to the buzzer module. Solder the potentiometer/trimpot/resistor to the VCC hole. I applied some super glue to hold the trimpot in place and avoid stress on the trimpot leg that is soldered.</td>
    </tr>
    <tr>
        <td>08</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build16.webp"><img src="images/build/build16_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>I soldered a trimpot facing down so I can level up/down the buzzer easily if I want to. This is the place where we are going to tie the module further.</td>
    </tr>
    <tr>
        <td>09</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build5.webp"><img src="images/build/build5_thumb.webp" alt="case" style="width:300px;"/></a></td>
    ...
    <tr>
        <td>10</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build6.webp"><img src="images/build/build6_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>This is all the parts soldered.</td>
    </tr>
    <tr>
        <td>11</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build7.webp"><img src="images/build/build7_thumb.webp" alt="case" style="width:300px;"/></a></td>
    ...
    <tr>
        <td>12</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build8.webp"><img src="images/build/build8_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>The solution was to hold the hex nut to the display with tape.</td>
    </tr>
    <tr>
        <td>13</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build9.webp"><img src="images/build/build9_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>The bottom hex nut was easier to screw so no tape needed. Be careful with the flat cable of the display. This cable will get pressed between the module and case.</td>
    </tr>
    <tr>
        <td>14</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build10.webp"><img src="images/build/build10_thumb.webp" alt="case" style="width:300px;"/></a></td>
    ...
    <tr>
        <td>15</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build11.webp"><img src="images/build/build11_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>Put a piece of the double-sided tape on the bottom of the module and remove the plastic protection.</td>
    </tr>
    <tr>
        <td>16</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build12.webp"><img src="images/build/build12_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>Place the buzzer module very deep into the case so the module does not block the USB/push buttons holes.</td>
    </tr>
    <tr>
        <td>17</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build13.webp"><img src="images/build/build13_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>Carefully fit all wires inside the case and put the push buttons in their places.</td>
    </tr>
    <tr>
        <td>18</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build14.webp"><img src="images/build/build14_thumb.webp" alt="case" style="width:300px;"/></a></td>
        <td>Close the case screwing the base.</td>
    </tr>
    <tr>
        <td>19</td>
        <td><a href="https://github.com/joaopedropio/snake-dongle/blob/master/images/build/build15.webp"><img src="images/build/build15_thumb.webp" alt="case" style="width:300px;"/></a></td>
